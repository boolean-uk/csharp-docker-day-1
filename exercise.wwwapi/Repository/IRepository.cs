...
namespace exercise.wwwapi.Repository
{
    public interface IRepository
    {
        ...
        public Task<Student?> CreateStudent(string FirstName, string LastName, DateOnly DateOfBirth);
        public Task<Student?> UpdateStudent(int id, string newFirstName, string newLastName, DateOnly DateOfBirth);
