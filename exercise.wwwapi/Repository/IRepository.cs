...
namespace exercise.wwwapi.Repository
{
    ...
    public interface IRepository
    {
        ...
        Task<IEnumerable<Student>> GetStudentsByCourse(int courseId, PreloadPolicy preloadPolicy = PreloadPolicy.DoNotPreloadRelations);

        Task<IEnumerable<Course>> GetCoursesByStudent(int studentId, PreloadPolicy preloadPolicy = PreloadPolicy.DoNotPreloadRelations);
    }
