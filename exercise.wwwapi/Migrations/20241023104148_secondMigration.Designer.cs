...
namespace exercise.wwwapi.Migrations
{
    ...
    [Migration("20241023104148_secondMigration")]
            ...
            modelBuilder.Entity("exercise.wwwapi.DataModels.Course", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            AverageGrade = 8.2f,
                            StartDate = new DateTime(2024, 11, 15, 17, 30, 0, 0, DateTimeKind.Utc),
                            Title = ".NET"
                        });
                });
            ...
            modelBuilder.Entity("exercise.wwwapi.DataModels.Student", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            courseId = 1,
                            dateOfBirth = new DateTime(1995, 6, 3, 18, 30, 0, 0, DateTimeKind.Utc),
                            firstName = "Øyvind",
                            lastName = "Onarheim"
                        });
                });
